    ...
    <DashboardCard title="서비스 소개">
      <Box>
        <Typography variant="body1" gutterBottom>
          ...
          효율적으로 탐색하고, 정보를 얻으며, 투자 결정을 내리는 데 도움을 주기
          위해 다음과 같은 기능들을 제공합니다.
        </Typography>
        <List>
          <ListItem>
            <Typography variant="body1">
              ...
              있습니다. 사용자가 원하는 회사를 쉽게 찾을 수 있도록, 검색 결과는
              명확하고 이해하기 쉬운 리스트 형태로 제공됩니다.
            </Typography>
          </ListItem>
          <ListItem>
            <Typography variant="body1">
          ...
          <ListItem>
            <Typography variant="body1">
              ...
              정보(공시, 가격 변동 등)를 구독하고, 이를 메일로 알림 받을 수 있는
        ...
        <Typography variant="body1">
          이 서비스들은 사용자가 주식 시장에서 보다 정보에 기반한 결정을 내리고,
          성공적인 투자 경험을 할 수 있도록 설계되었습니다.
        </Typography>
      </Box>
    </DashboardCard>
  </PageContainer>
